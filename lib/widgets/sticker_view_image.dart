...
typedef StickeImageRemoveCallback = void Function(FlutterSimpleStickerImage sticker);
  ...
  Widget build(BuildContext context) {
    return Positioned.fromRect(
      rect: Rect.fromPoints(
          Offset(_offset.dx, _offset.dy), Offset(_offset.dx + widget.width, _offset.dy + widget.height)),
      child: Container(
        child: Stack(
          children: <Widget>[
            Center(
